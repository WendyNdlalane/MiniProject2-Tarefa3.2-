...
const routes = [
  ...
  },
  {
    path: "/admin/sponsors",
    name: "listSponsors",
    component: () => import("@/views/sponsors/ListSponsors")
  },
  {
    path: "/admin/sponsors/add",
    name: "addSponsor",
    component: () => import("@/views/sponsors/AddSponsor")
  },
  {
    path: "/admin/experts",
    name: "listExperts",
    component: () => import("@/views/experts/ListExperts")
  },
  {
    path: "/admin/experts/add",
    name: "addExpert",
    component: () => import("@/views/experts/AddExpert")
  },
