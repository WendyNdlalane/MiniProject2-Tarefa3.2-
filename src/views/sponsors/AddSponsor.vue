          ...
          <form @submit.prevent="add">
            ...
            <div class="form-group">
              <select id="sltGroup" class="form-control form-control-lg" v-model="group" required>
                ...
                <option value="ferro">PADRINHO FERRO</option>
                <option value="bronze">PADRINHO BRONZE</option>
                <option value="patra">PADRINHO PRATA</option>
                <option value="ouro">PADRINHO OURO</option>
              </select>
            </div>
            <div class="form-group">
              <input
